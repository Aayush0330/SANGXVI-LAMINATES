  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[0.75fr_1.25fr]">
      <section className="overflow-hidden rounded-[30px] border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#0d182a]">
        <div className="bg-gradient-to-br from-white via-blue-50 to-indigo-50 p-7 text-slate-950 dark:from-slate-950 dark:via-blue-950 dark:to-indigo-900 dark:text-white"><div className="flex h-20 w-20 items-center justify-center rounded-[26px] border border-blue-100 bg-white text-2xl font-black text-blue-700 shadow-sm dark:border-white/15 dark:bg-white/10 dark:text-white">{initials || "D"}</div><h2 className="mt-5 text-2xl font-black">{profile?.businessName ?? dealer.name}</h2><p className="mt-1 text-sm font-semibold text-slate-600 dark:text-blue-100">{dealer.name} · Authorized Sanghvi Dealer</p><span className="mt-4 inline-flex rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.12em] text-emerald-700 dark:border-emerald-300/30 dark:bg-emerald-400/15 dark:text-emerald-200">Active account</span></div>
