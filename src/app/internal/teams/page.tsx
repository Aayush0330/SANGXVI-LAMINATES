                        ...
                        <div className="grid gap-4 md:grid-cols-[150px_1fr]">
                          ...
                          <div className="border-slate-200 md:border-l md:pl-4 dark:border-slate-800">
                            ...
                            <div className="mt-3 grid gap-2 sm:grid-cols-2 xl:grid-cols-3">
                              {workersOnly.length ? (
                                workersOnly.map((member, memberIndex) => (
                                  <div
                                    key={member.id}
                                    ...
                                    className="flex min-w-0 items-center gap-2.5 rounded-xl border border-slate-200 bg-slate-50 px-2.5 py-2 dark:border-slate-700 dark:bg-slate-950"
                                  >
                                    <span
                                      className={`grid h-9 w-9 shrink-0 place-items-center rounded-full text-[11px] font-black text-white shadow-sm ${
                                        [
                                          "bg-blue-500",
                                          "bg-violet-500",
                                          "bg-emerald-500",
